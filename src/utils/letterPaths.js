...
export const LETTER_PATHS = {
  ...
  J: [
    [ { x: 40, y: 15 }, { x: 80, y: 15 } ],
    [ { x: 60, y: 15 }, { x: 60, y: 70 }, { x: 50, y: 85 }, { x: 30, y: 85 }, { x: 20, y: 75 } ]
  ],
  K: [
    [ { x: 30, y: 15 }, { x: 30, y: 85 } ],
    [ { x: 70, y: 15 }, { x: 30, y: 50 } ],
  ...
  P: [
    [ { x: 30, y: 15 }, { x: 30, y: 85 } ],
    [ { x: 30, y: 15 }, { x: 60, y: 15 }, { x: 75, y: 30 }, { x: 75, y: 40 }, { x: 60, y: 50 }, { x: 30, y: 50 } ]
  ],
  Q: [
    [ 
      { x: 50, y: 15 }, { x: 75, y: 25 }, { x: 85, y: 50 }, { x: 75, y: 75 }, 
      { x: 50, y: 85 }, { x: 25, y: 75 }, { x: 15, y: 50 }, { x: 25, y: 25 }, { x: 50, y: 15 } 
    ],
    [ { x: 60, y: 65 }, { x: 85, y: 90 } ]
  ],
  R: [
